...
const AboutMe = () => {
    return(
        <AboutMeSection>
            ...
            <p className="about-p">I love to work with <span className="color-span">React</span> but I'm open to falling in love with other frameworks. I've <span className="color-span">worked in server side,</span> too, and I would be hard pressed to pick between it and client side development if the choice was equal. I expect to work in one or the other for the rest of my life, if not both. If you want more information on that aspect of me, my <span className="color-span">resume</span> will be more your thing.</p>
