...
const Landing = () => {
    return (
        <Section>
            ...
            <p>The app you're currently visiting is a <span className="color-span">single-page React app,</span> architected to be semantic, functional, and easy on the eyes. It is designed with styled-components. If that's the sort of thing you're looking for, you've found your guy. If not, check out my resume and portfolio, you may see something else you like.</p>
