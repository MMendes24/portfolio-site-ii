...
const Portfolio = () => {
    return (
        <PortfolioSection>
            <h2 className="project-header">><span className="color-span">Projects</span></h2>
            <p className="desc-class">(currently for layout testing, actual projects and images coming soon)</p>
